...
<body id="index" class="lang-en country-us currency-usd layout-full-width page-index tax-display-disabled fullwidth">
  ...
  <div id="field_slideshow" class="slideshow">
    <div class="field-main-slider  block" style="overflow: hidden;">
      <div id="insideslider_mod" class="outer-slide" style="width: 1920px; height: 650px">
        <div class="loading">
...
<div class="tab-category-container-slider horizontal_mode block">
  <div class="tab-category-slider">
    <div class="title_block title_font">
      ...
      <p class="content-title">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
      <ul class="tab_cates">
        <li rel="tab_3"  class="active">Shop</li>
        <li rel="tab_14"> Gift for men</li>
        <li rel="tab_15"> Girls</li>
        <li rel="tab_16"> Earings</li>
      </ul>
    </div>
    <div class="tab_cate_container">
      <div id="tab_3" class="tab_category_slider">
        <div class="row">
      ...
      <script type="text/javascript"> 
        ...
        $('.tab-category-container-slider #tab_3 .tabcate_content').owlCarousel({
            itemsCustom: [ [0, 1], [320, 1], [480, 2], [768, fieldtabcatepsl_mediumitem], [992, fieldtabcatepsl_maxitem], [1200, fieldtabcatepsl_maxitem] ],
      ...
      <div id="tab_14" class="tab_category_slider">
        <div class="row">
          <div class="tabcate_content carousel-grid owl-carousel">
            <div class="item">
              <div class="item-inner">
      ...
      <div id="tab_15" class="tab_category_slider">
        <div class="row">
          <div class="tabcate_content carousel-grid owl-carousel">
            <div class="item">
              <div class="item-inner">
      ...
      <div id="tab_16" class="tab_category_slider">
        <div class="row">
          <div class="tabcate_content carousel-grid owl-carousel">
            <div class="item">
              <div class="item-inner">
            ...
            <div class="col-xs-12 col-sm-12 col-md-7">
              <div class="total1 js-qv-mask mask">
                <div class="product-images ">
                  <div id="carousel1-0">
                    <ul id="carousel-0" class="ul-product-images">
                      <li class="vertical-thumb">
                        <img 
                          class="thumb js-thumb_1 selected"
                          data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/68-medium_default/dummy-text-of-the.jpg"
                          data-id="vertical0"
                          data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/68-feature_default/dummy-text-of-the.jpg"
                          src="images/products/dummy-text-of-the-1.jpg"
                          alt=""
                          title=""
                        />
                      </li>
                      <li class="vertical-thumb">
                        <img 
                          class="thumb js-thumb_1"
                          data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/69-medium_default/dummy-text-of-the.jpg"
                          data-id="vertical0"
                          data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/69-feature_default/dummy-text-of-the.jpg"
                          src="images/products/dummy-text-of-the-2.jpg"
                          alt=""
                          title=""
                        />
                      </li>
                      <li class="vertical-thumb">
                        <img 
                          class="thumb js-thumb_1"
                          data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/72-medium_default/dummy-text-of-the.jpg"
                          data-id="vertical0"
                          data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/72-feature_default/dummy-text-of-the.jpg"
                          src="images/products/dummy-text-of-the-3.jpg"
                          alt=""
                          title=""
                        />
                      </li>
              ...
              <div class="product-miniature js-product-miniature" data-id-product="12" data-id-product-attribute="58" itemscope itemtype="http://schema.org/Product">
                <div class="left-product">
                  <a href="bakeware/12-58-dummy-text-of-the.html#/1-size-s/14-color-blue" class="thumbnail product-thumbnail">
                    <span class="cover_image vertical0">
                      <img
                        class="js-qv-product-cover_1"
                        src = "images/products/large-placeholder.jpg"
                        data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/68-field_zoom_default/dummy-text-of-the.jpg"
                        alt=""
                        width="462"
                        height="582"
                      />
              ...
              <div class="right-product">
                <div class="product-description">
                  <div class="product_name">
                    <a href="bakeware/12-58-dummy-text-of-the.html#/1-size-s/14-color-blue">Dummy text of the.</a>
                  </div>
                  <div class="product-price-and-shipping">
                  ...
                  <div class="short_desc">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tem portul indunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud  exercitation ullamco laboris nisi</p>
                  </div>
                  <div class="countdown">
                    <span class="item-countdown">
                      <span class="bg_tranp"></span>
                      <span class="item-countdown-time" data-time="2021-08-17 00:00:00"></span>
                    </span>
                  </div>   
          ...
          <div class="item-inner">
            <div class="col-xs-12 col-sm-12 col-md-7">
              <div class="total1 js-qv-mask mask">
                <div class="product-images">
                  <div id="carousel1-1">
                    <ul id="carousel-1" class="ul-product-images">
                      <li class="vertical-thumb">
                        <img 
                        class="thumb js-thumb_1  selected"
                        data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/64-medium_default/lorem-ipsum-has.jpg"
                        data-id="vertical1"
                        data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/64-feature_default/lorem-ipsum-has.jpg"
                        src="images/products/lorem-ipsum-has-1.jpg"
                        alt=""
                        title=""
                        />
                      </li>
                      <li class="vertical-thumb">
                        <img 
                        class="thumb js-thumb_1"
                        data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/65-medium_default/lorem-ipsum-has.jpg"
                        data-id="vertical1"
                        data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/65-feature_default/lorem-ipsum-has.jpg"
                        src="65-newp_default/lorem-ipsum-has.jpg"
                        alt=""
                        title=""
                        />
                      </li>
                      <li class="vertical-thumb">
                        <img 
                        class="thumb js-thumb_1"
                        data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/66-medium_default/lorem-ipsum-has.jpg"
                        data-id="vertical1"
                        data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/66-feature_default/lorem-ipsum-has.jpg"
                        src="66-newp_default/lorem-ipsum-has.jpg"
                        alt=""
                        title=""
                        />
                      </li>
              ...
              <div class="product-miniature js-product-miniature" data-id-product="11" data-id-product-attribute="57" itemscope itemtype="http://schema.org/Product">
                <div class="left-product">
                  <a href="testimonial/11-57-lorem-ipsum-has.html#/1-size-s/11-color-black" class="thumbnail product-thumbnail">
                    <span class="cover_image vertical1">
                      <img 
                      class="js-qv-product-cover_1"
                      src = "64-feature_default/lorem-ipsum-has.jpg"
                      data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/64-field_zoom_default/lorem-ipsum-has.jpg"
                      alt=""
                      width="462"
                      height="582"
                      >
            ...
            <div class="col-xs-12 col-sm-12 col-md-5">
              <div class="right-product">
                <div class="product-description">
                  <div class="product_name">
                    <a href="testimonial/11-57-lorem-ipsum-has.html#/1-size-s/11-color-black">Lorem Ipsum has.</a>
                  </div>
                  <div class="product-price-and-shipping">
                  ...
                  <div class="countdown">
                    <span class="item-countdown">
                      <span class="bg_tranp"></span>
                      <span class="item-countdown-time" data-time="2021-08-13 00:00:00"></span>
                    </span>
                  </div>
                  <div class="button-action1">
                    <a class="slide-button title_font" href="#">
          ...
          <div  class="item-inner">
            <div class="col-xs-12 col-sm-12 col-md-7">
              <div class="total1 js-qv-mask mask">
                <div class="product-images">
                  <div id="carousel1-2">
                    <ul id="carousel-2" class="ul-product-images">
                      <li class="vertical-thumb">
                        <img 
                        class="thumb js-thumb_1  selected"
                        data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/60-medium_default/standard-dumm.jpg"
                        data-id="vertical2"
                        data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/60-feature_default/standard-dumm.jpg"
                        src="60-newp_default/standard-dumm.jpg"
                        alt=""
                        title=""
                        />
                      </li>
                      <li class="vertical-thumb">
                        <img 
                        class="thumb js-thumb_1"
                        data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/61-medium_default/standard-dumm.jpg"
                        data-id="vertical2"
                        data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/61-feature_default/standard-dumm.jpg"
                        src="61-newp_default/standard-dumm.jpg"
                        alt=""
                        title=""
                        />
                      </li>
                      <li class="vertical-thumb">
                        <img 
                        class="thumb js-thumb_1 "
                        data-image-medium-src="http://demo.fieldthemes.com/ps_modo/home1/62-medium_default/standard-dumm.jpg"
                        data-id="vertical2"
                        data-image-large-src="http://demo.fieldthemes.com/ps_modo/home1/62-feature_default/standard-dumm.jpg"
                        src="62-newp_default/standard-dumm.jpg"
                        alt=""
                        title=""
                        />
                      </li>
              ...
              <div class="product-miniature js-product-miniature" data-id-product="10" data-id-product-attribute="52" itemscope itemtype="http://schema.org/Product">
                <div class="left-product">
                  <a href="testimonial/10-52-standard-dumm.html#/1-size-s/10-color-red" class="thumbnail product-thumbnail">
                    <span class="cover_image vertical2">
                      <img
                      class="js-qv-product-cover_1"
                      src = "60-feature_default/standard-dumm.jpg"
                      data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/60-field_zoom_default/standard-dumm.jpg" alt=""
                      width="462"
                      height="582"
                      >
                    </span>
            ...
            <div class="col-xs-12 col-sm-12 col-md-5">
              <div class="right-product">
                <div class="product-description">
                  <div class="product_name">
                    <a href="testimonial/10-52-standard-dumm.html#/1-size-s/10-color-red">Standard dumm.</a>
                  </div>
                  <div class="product-price-and-shipping">
                    <span class="price">$36.00</span>
                    <span class="regular-price">$40.00</span>
...
function vertical(a,b){
  ...
  $(a).css('height', $(b).children((":first")).outerHeight()*items + 'px');
}
});
</script>
...
<div class="container" style="padding-top: 100px;">
  ...
  <div id="field_newproductslider_block" class="block title_center horizontal_mode clearfix">
    <h4 class="title_block title_font">
      <a class="title_text" href="new-products.html" title="New Arrivals">
        New Arrivals
      </a>
    </h4>
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <div class="features-conten">
          <a href="#"><img src="modules/fieldstaticblocks/images/banner13.jpg" alt="" /></a>
        </div>
      </div>
      <div class="col-xs-12 col-md-6">
        <div class="row">
                ...
                <div class="product-miniature js-product-miniature" data-id-product="12" data-id-product-attribute="58" itemscope itemtype="http://schema.org/Product">
                  <div class="left-product">
                    <a href="bakeware/12-58-dummy-text-of-the.html#/1-size-s/14-color-blue" class="thumbnail product-thumbnail">
                      <span class="cover_image">
                        <img
                        src = "images/products/dummy-text-of-the-68-1.jpg"
                        data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/68-field_zoom_default/dummy-text-of-the.jpg"
                        alt=""
                        width="270"
                        height="340"
                      ...
                      <span class="hover_image">
                        <img 
                        src = "images/products/dummy-text-of-the-69-1.jpg"
                        data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/69-home_default/dummy-text-of-the.jpg"
                        alt=""
                        width="270"
                        height="340"
                        >
                ...
                <div class="product-miniature js-product-miniature" data-id-product="11" data-id-product-attribute="57" itemscope itemtype="http://schema.org/Product">
                  <div class="left-product">
                    <a href="testimonial/11-57-lorem-ipsum-has.html#/1-size-s/11-color-black" class="thumbnail product-thumbnail">
                      <span class="cover_image">
                        <img
                        src = "images/products/lorem-ipsum-has-64.jpg"
                        data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/64-field_zoom_default/lorem-ipsum-has.jpg"
                        alt=""
                        width="270"
                        height="340"
                      ...
                      <span class="hover_image">
                        <img 
                        src = "images/products/lorem-ipsum-has-65.jpg"
                        data-full-size-image-url = "http://demo.fieldthemes.com/ps_modo/home1/65-home_default/lorem-ipsum-has.jpg"
                        alt=""
                        width="270"
                        height="340"
                        >
...
$(window).load(function() {
  ...
  <div class="block_newsletter col-md-12 col-sm-12">
    <div class="block_newsletter_item">
      <div class="row">
        <div class="col-md-4 col-xs-12">
          <div class="footer-newsletter-title">
            <h4><span>Subscribe to say update with</span></h4>
            <p>latest news and discount</p>
          </div>
        </div>
        <div class="col-md-8 col-xs-12 newsletter-back">
          <form action="http://demo.fieldthemes.com/ps_modo/home1/en/#footer" method="post">
            <div class="row">
              <div class="col-xs-12">
...
<div class="container">
  <div class="smart-blog-home-post block horizontal_mode">
    <h2 class="title_block title_font">
      <a class="title_text" href="smartblog.html">Latest Blog</a>
          ...
          <div class="news_module_image_holder">
            <div class="inline-block_relative">
              <div class="image_holder_wrap">
                <a href="smartblog/8_Aliquam-tincidunt-mauris-eu-risus-.html">
                  <img alt="Aliquam tincidunt mauris eu risus."
                  class="img-responsive"
                  src="images/blog/8-home-default.jpg"
                  width="370"
                  height="200" 
                  >
                </a>
              </div>
              <div class="border_opacity0">
                <div class="right_blog_home">
                  <div class="content">
                    <h3 class="sds_post_title">
                      <a href="smartblog/8_Aliquam-tincidunt-mauris-eu-risus-.html">Aliquam tincidunt mauris eu risus.</a>
                    </h3>
                    <p>
              ...
              <div class="blog_home">
                ...
                <div class="right_blog">
                  <span>By <a href="http://fieldthemes.com/">Fieldthemes</a>   /    April 19, 2017 </span>
                </div>
              </div>
  ...
  <div id="moda_popupnewsletter" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="max-width:700px;">
      <div class="modal-content">
        ...
        <div class="fieldpopupnewsletter" style="width:700px;height:400px;background-image: url(images/popup.jpg);">
          <div id="newsletter_block_popup" class="block">
            <div class="block_content">
              <form method="post">
                ...
                <input class="inputNew" id="newsletter-input-popup" type="text" name="email" placeholder="Enter your email address"/>
                <div class="ful"><div class="send-reqest button_unique main_color_hover">Subscribe</div></div>
              </form>
            </div>
              ...
              <div class="media">
                <div class="media-content">
                  <span class="fancybox-media">
                    <img class="img-responsive" src="images/testimonials/face.jpg" alt="Image Testimonial"/>
                  </span>
                </div>
                <div class="content_test">
                  <p class="des_namepost">Martin frank</p>
                  <p class="des_company"> - CEO Fieldthemes </p>
                </div>
              </div>
              <div class="content_test_top">
                <div class="des_testimonial">
                  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                </div>
              </div>
            </div>
            <div class="main-block">
...
<div id="fieldbrandslider" class="block title_center horizontal_mode">
  <div class="container">
    <h4 class="title_block title_font"><a class="title_text" href="brands.html">Our brands</a></h4>
    <div class="row">
      <div id="fieldbrandslider-manufacturers" class="grid carousel-grid owl-carousel">
        <div class="item">
          <a class="img-wrapper" href="1_brandlogo1.html" title="brand_logo1">
            <img class="img-responsive"
            src="images/manufacturer/1-field_manufacture.jpg"
            alt="brand_logo1"
            width="170"
            height="112"
            />
        ...
        <div class="item">
          <a class="img-wrapper" href="2_brandlogo2.html" title="brand_logo2">
            <img class="img-responsive" 
            src="images/manufacturer/2-field_manufacture.jpg"
            alt="brand_logo2" 
            width="170"
            height="112"
            />
        ...
        <div class="item">
          <a class="img-wrapper" href="3_brandlogo3.html" title="brand_logo3">
            <img class="img-responsive" 
            src="images/manufacturer/3-field_manufacture.jpg"
            alt="brand_logo3" 
            width="170"
            height="112"
            />
        ...
        <div class="item">
          <a class="img-wrapper" href="4_brandlogo4.html" title="brand_logo4">
            <img class="img-responsive" 
            src="images/manufacturer/4-field_manufacture.jpg"
            alt="brand_logo4" 
            width="170"
            height="112"
            />
        ...
        <div class="item">
          <a class="img-wrapper" href="5_brandlogo5.html" title="brand_logo5">
            <img class="img-responsive" 
            src="images/manufacturer/5-field_manufacture.jpg"
            alt="brand_logo5"
            width="170"
            height="112"
            />
        ...
        <div class="item">
          <a class="img-wrapper" href="6_brandlogo6.html" title="brand_logo6">
            <img class="img-responsive" 
            src="images/manufacturer/6-field_manufacture.jpg"
            alt="brand_logo6" 
            width="170"
            height="112"
            />
        ...
        <div class="item">
          <a class="img-wrapper" href="7_brandlogo7.html" title="brand_logo7">
            <img class="img-responsive" 
            src="images/manufacturer/7-field_manufacture.jpg"
            alt="brand_logo7" 
            width="170"
            height="112"
            />
